    ...
    <div class="flex flex-col md:flex-row lg:px-64 pb-8 justify-center text-rti_ing_white">
        <div class="w-auto md:w-1/2 lg:w-1/6 lg:mr-20">
            ...
            <div class="text-center text-xl">
                <p class=""><span class="text-green-800">《特獎》</span>共五名，各獲得一個<span class="text-green-800">台灣製</span>的多功能運動<span class="text-green-800">背包</span>。</p>
        ...
        <div class="w-auto md:w-1/2 lg:w-1/6 lg:mr-20">
            ...
            <div class="text-center text-xl">
                <p><span class="text-green-800">《頭獎》</span>共五名，各獲得一件<span class="text-green-800">台灣製</span>的多功能運動<span class="text-green-800">機能衣</span>。</p>
                <p class="">(長袖機能衣示意圖)</p>
            </div>
        </div>
       </div>
